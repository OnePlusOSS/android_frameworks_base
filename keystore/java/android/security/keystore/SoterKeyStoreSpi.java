...
public class SoterKeyStoreSpi extends android.security.keystore.AndroidKeyStoreSpi{
	...
	//vivo chenlingyun add for delete entry begin
	/*
	 *vivo need make 5.0 and 6.0 keystore framework compatible, some process may chang,
	 *do things here is more controllable 
	...
	//vivo chenlingyun add for delete entry end
}
