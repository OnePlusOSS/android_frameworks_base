...
interface INfcAdapter
{
    ...
    boolean oemsetDefaultRoute(int defaultRouteEntry, int defaultProtoRouteEntry, int defaultTechRouteEntry);
    boolean getNfcSupportUICC();
    boolean setCurrentRoute( int currentRoute);
    int getCurrentRoute();
}
